...
const EditChalani: NextPageWithLayout = () => {
      ...
      <Box p={20} className="darta-form">
        ...
        <Paper>
          <form onSubmit={form.onSubmit(handleFormSubmit)}>
            ...
            <Button className="fs-16 fw-500" type="submit" mt={10} w="20%"> Update</Button>
          </form>
        </Paper>
      </Box>
    </section>
...
EditChalani.getLayout = function getLayout(page) {
  return <Layout>{page}</Layout>;
};

export default EditChalani;
